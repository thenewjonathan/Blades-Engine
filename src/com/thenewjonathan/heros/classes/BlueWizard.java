...
public class BlueWizard extends Arcane implements IHasAbilities, IHero
{
	...
	public BlueWizard(String name, Genders gender, int level, int strength, int agility, int intelligence, int accuracy,
	...
	{
		super.getAbilities().add(Abilities.summonMephit.getAbility());
		super.getAbilities().add(Abilities.summonDrake.getAbility());
	}

	@Override
	public void attack(Combatant target)
	{
		CommonFunctions.say("The Blue Wizard does not have the ability to make a physical attack");
	}

	@Override
	public BlueWizard clone()
	{
		BlueWizard c =
				new BlueWizard(getName(), getGender(), getLevel(), getStrength(), getAgility(), getIntelligence(),
