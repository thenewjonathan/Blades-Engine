...
public class ObadHaiFollower extends Divine implements IHasAbilities, IHero
{

	public ObadHaiFollower()
	{
		super();
		loadAbilities();
	...
	public ObadHaiFollower(String name, Genders gender, int level, int strength, int agility, int intelligence,
	...
	@Override
	public ObadHaiFollower clone()
	{
		ObadHaiFollower c =
				new ObadHaiFollower(getName(), getGender(), getLevel(), getStrength(), getAgility(), getIntelligence(),
	...
	{
		super.getAbilities().add(Abilities.ensnare.getAbility());
		super.getAbilities().add(Abilities.shapeShift.getAbility());
		super.getAbilities().add(Abilities.shalmSong.getAbility());
	}
