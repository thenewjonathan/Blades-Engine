...
public class ElementalBlade extends Power implements IHasAbilities, IHero
{

	public ElementalBlade()
	{
		super();
		loadAbilities();
	...
	public ElementalBlade(String name, Genders gender, int level, int strength, int agility, int intelligence,
	...
	@Override
	public ElementalBlade clone()
	{
		ElementalBlade c =
				new ElementalBlade(getName(), getGender(), getLevel(), getStrength(), getAgility(), getIntelligence(),
	...
	{
		super.getAbilities().add(Abilities.flameBlade.getAbility());
		super.getAbilities().add(Abilities.frostBlade.getAbility());
		super.getAbilities().add(Abilities.lightningBlade.getAbility());
	}
